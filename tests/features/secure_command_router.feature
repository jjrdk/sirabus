Feature: Send commands and receive responses over TLS

  Scenario Template: Send a command and receive a response over TLS
    ...
    And a <serializer> <broker_type> router with TLS enabled is created with the hierarchical topic map
